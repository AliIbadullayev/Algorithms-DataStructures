...
## Решения
1. Участок с приоритетами машинок разделяются на маленькие участки с разнообразными машинками (`не более K`). 
2. Работаем со структурой данных, в которую легко записывать и удалять данные.